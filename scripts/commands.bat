...
docker run -d --name elastic-system --network elastic -p 8085:8085 -e ES_HOST=elasticsearch -e ES_PORT=9200 -e ES_INDEX=iranian kodkod1docker/elastic-malicious-text-system:v1.0